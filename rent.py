...
class VehicleRent:
    ...
    def rentHourly(self, n):
        ...
        if n <= 0:
            ...
            print("Sory. {} vehicle available to rent".format(self.stock))
            return None
        else:
...
class Customer:
    ...
    def requestVehicle(self,brand):
        ...
        """
        if brand == "bike":
            bikes = input("How many bikes would you like to brand? ")
            try:
                bikes = int(bikes)
            except ValueError:
            ...
            cars = input("How many cars would you like to brand? ")
            try:
                cars = int(cars)
            except ValueError:
                print("Value should be number")
